module QME
  ...
  module MapReduce
    ...
    class Executor
      ...
      def count_records_in_measure_groups(fullListNumerator, fullListDenominator, full)
        ...
        result.merge!({ :fullListNumerator => fullListNumerator, :fullListDenominator => fullListDenominator })
